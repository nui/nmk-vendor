...
gcloud builds submit --async --substitutions=_LOCAL_PATH=/home/nui/.nmk/local,_DOCKER_TAG=centos-6.9,_TAR_NAME=tmux-3.0--nui--centos-6.9
gcloud builds submit --async --substitutions=_LOCAL_PATH=/home/beid/.nmk/local,_DOCKER_TAG=centos-6.9,_TAR_NAME=tmux-3.0--beid--centos-6.9
gcloud builds submit --async --substitutions=_LOCAL_PATH=/home/ubuntu/.nmk/local,_DOCKER_TAG=centos-6.9,_TAR_NAME=tmux-3.0--ubuntu--centos-6.9
gcloud builds submit --async --substitutions=_LOCAL_PATH=/root/.nmk/local,_DOCKER_TAG=centos-6.9,_TAR_NAME=tmux-3.0--root--centos-6.9
